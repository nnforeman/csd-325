...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        self.title("Foreman-ToDo")
        self.geometry("300x400")

        menu_bg = "#004c99"
        menu_fg = "white"

        menubar = tk.Menu(self, bg=menu_bg, fg=menu_fg, activebackground="white",
                          activeforeground=menu_bg)

        file_menu = tk.Menu(menubar, tearoff=0, bg=menu_bg, fg=menu_fg,
                            activebackground="white", activeforeground=menu_bg)
        ...
        todo1 = tk.Label(self.tasks_frame, text="--- Add Items Here ---\n(Right-click a task to delete it)", bg="lightgrey", fg="black", pady=10)
